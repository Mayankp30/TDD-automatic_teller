...
public class DriverModel {
	...
	view view1 =  new view();
	customer cust = new customer("MAYANK PUROHIT","4802785779", "1991", 0,0, 5000, 5000);
	customer cust1 = new customer("PIYUSH MANTRI","0123456789", "1990", 0,0, 5000, 5000);
	...
	public void testmodel1()
	{
		ArrayList arr = model1.getListCustomer();
		 ...
		 assertEquals("PIYUSH MANTRI",str.getFirstName());
	...
	public void testmodel2()
	{
		ArrayList arr = model1.getListCustomer();
		 ...
		 assertEquals("MAYANK PUROHIT",str.getFirstName());
	...
	public void testmodel3()
	{
		ArrayList arr = model1.getListCustomer();
		 ...
		 assertEquals("JOHN CENA",str.getFirstName());
	...
	public void testmodel4()
	{
		ArrayList arr = model1.getListCustomer();
		 ...
		 assertEquals("DWAYNE JOHNSON",str.getFirstName());
