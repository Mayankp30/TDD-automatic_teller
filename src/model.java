...
public class model {
    ...
    public static boolean getisCashDispenserDoorReady(){
        ...
        public model(){
            ...
            listCustomer.add(new customer("PIYUSH MANTRI","0123456789", "1990", 0,0, 5000, 5000));
            listCustomer.add(new customer("MAYANK PUROHIT","4802785779", "1991", 0,0, 5000, 5000));
            listCustomer.add(new customer("JOHN CENA","1234567890", "1989", 0,0, 5000, 5000));
            listCustomer.add(new customer("DWAYNE JOHNSON","9876543210", "1992", 0,0, 5000, 5000));
